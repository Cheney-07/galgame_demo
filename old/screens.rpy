...
screen say(who, what):
    ...
    ## 检查当前对话是否已阅读过
    python:
        seen = any(h.what == what for h in _history_list)
...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            imagebutton:
                idle Transform("gui/icon_start_idle.png", zoom=0.4, xalign=0.5, xoffset=-10)
                hover Transform("gui/kaishi_gaoliang.png", zoom=0.27, xalign=0.5, xoffset=-10)
                xsize 320
                at nav_hover
                action Start()

            imagebutton:
                idle Transform("gui/icon_cg_idle.png", zoom=0.4, xalign=0.5,xoffset=-5)
                hover Transform("gui/cg_gaoliang.png", zoom=0.45, xalign=0.5, xoffset=-12)
                xsize 320
                at nav_hover
                action ShowMenu("cg_gallery_screen")

            imagebutton:
                idle Transform("gui/duqu.png", zoom=0.4, xalign=0.5, xoffset=-12)
                hover Transform("gui/duqu_gaoliang.png", zoom=0.45, xalign=0.5, xoffset=-9)
                xsize 320
                at nav_hover
                action ShowMenu("load")

            imagebutton:
                idle Transform("gui/shezhi.png", zoom=0.4, xalign=0.5,xoffset=-5)
                hover Transform("gui/shezhi_gaoliang.png", zoom=0.43, xalign=0.5, xoffset=-5)
                xsize 320
                at nav_hover
                action ShowMenu("preferences")

            imagebutton:
                idle Transform("gui/guanyu.png", zoom=0.4, xalign=0.5, xoffset=-7)
                hover Transform("gui/guanyu_gaoliang.png", zoom=0.43, xalign=0.5, xoffset=2,yoffset=4)
                xsize 320
                at nav_hover
            ...
            if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):
                ...
                imagebutton:
                    idle Transform("gui/bangzhu.png", zoom=0.4, xalign=0.5)
                    hover Transform("gui/bangzhu_gaoliang.png", zoom=0.42, xalign=0.5, xoffset=2,yoffset=4 )
                    xsize 320
                    at nav_hover
            ...
            if renpy.variant("pc"):
                ...
                imagebutton:
                    idle Transform("gui/tuichu.png", zoom=0.4, xalign=0.5, xoffset=-10)
                    hover Transform("gui/tuichu_gaoliang.png", zoom=0.44, xalign=0.5, xoffset=5)
                    xsize 320
                    at nav_hover
            ...
            textbutton _("CG 画廊") action ShowMenu("cg_gallery_screen")
...
screen main_menu():
    ...
    add Transform("gui/main_menu.png", size=(1920, 1080))
    ...
    ## 右侧角色立绘展示 - 400x800，依次出现，分散排列，整体上移，左侧角色更高
    add "char_selena_scaled":
        align (0.58, -0.58)
        at char_appear(0)
    add "char_noel_scaled":
        align (0.78, 0.10)
        at char_appear(1)
    add "char_elsia_scaled":
        align (0.64, 0.53)
        at char_appear(2)
    add "char_lyra_scaled":
        align (0.89, 0.06)
        at char_appear(3)
    add "char_vespera_scaled":
        align (1.15, -1.21)
        at char_appear(4)


## 角色出现动画 - 从下方渐入
transform char_appear(index):
    pause index * 0.25
...
## 在 init 时预定义缩放后的角色图片
init python:
    renpy.image("char_selena_scaled", im.Scale("images/char_selena.png", 400, 800))
    renpy.image("char_elsia_scaled", im.Scale("images/char_elsia.png", 400, 800))
    renpy.image("char_noel_scaled", im.Scale("images/char_noel.png", 300, 600))
    renpy.image("char_lyra_scaled", im.Scale("images/char_lyra.png", 400, 800))
    renpy.image("char_vespera_scaled", im.Scale("images/char_vespera.png", 800, 1000))
